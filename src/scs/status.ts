...
const getEXP = (g: GrowType, lv: number): number => {
  switch (g) {
...
const getMHPGrow = (g: GrowType, lv: number): number => {
  switch (g) {
    case GrowType.FutsuSojuku:
      return [
        0,
...
const getATKGrow = (g: GrowType, lv: number): number => {
  switch (g) {
    case GrowType.FutsuSojuku:
      return [
        0,
...
const getDEFGrow = (g: GrowType, lv: number): number => {
  switch (g) {
    case GrowType.FutsuSojuku:
      return [
        0,
...
interface BasicMonsterStatus {
  readonly name?: string;
  readonly growType: GrowType;
  mhp0: number;
  atk0: number;
  def0: number;
  exp: number;
...
export const getBasicMonsterStatus = (name: string, lv: number): BasicMonsterStatus => {
  const basicMonsterStatusDict: { [index: string]: BasicMonsterStatus } = {
    ...
    エリミネーター: {
      growType: GrowType.KogekiSojuku,
      mhp0: 100,
      atk0: 30,
      def0: 35,
      maximumLv: 99,
    ...
    アイアンタートル: {
      growType: GrowType.BougyoSojuku,
      mhp0: 30,
      atk0: 18,
      def0: 19,
      maximumLv: 99,
    ...
    あくましんかん: {
      growType: GrowType.KogekiBansei,
      mhp0: 48,
      atk0: 22,
      def0: 15,
      maximumLv: 99,
    ...
    アイアンアント: {
      growType: GrowType.BougyoBansei,
      mhp0: 17,
      atk0: 13,
      def0: 20,
      maximumLv: 99,
    ...
    アトラス: {
      growType: GrowType.KogekiTokusyu,
      mhp0: 130,
      atk0: 60,
      def0: 48,
      maximumLv: 10,
    ...
    あやしいかげ: {
      growType: GrowType.SyubiTokusyu,
      mhp0: 5,
      atk0: 20,
      def0: 1,
      maximumLv: 9,
  ...
  const msd = basicMonsterStatusDict[name];
  if (!msd) {
