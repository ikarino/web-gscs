      ...
      <Card>
        ...
        <Accordion.Collapse eventKey="0">
          <Card.Body>
            ...
            <h5>待機率</h5>
            <p className="small">行動できなかったターンの割合です。モンスターごと、または10体のモンスターの平均として算出しています。0%が望ましい状態です。</p>
            <h5>分裂ロス</h5>
            <p className="small">スモールグールに攻撃した際に分裂するスペースが無かった回数（ターン当たり）です。0が望ましい状態です。</p>
          </Card.Body>
        </Accordion.Collapse>
      </Card>
